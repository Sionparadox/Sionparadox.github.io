export const metadata = {
  title: '[Platinum IV] 문명 - 14868',
  date: '2026-03-10 08:55:26',
  tags: ['자료 구조', '그래프 이론', '그래프 탐색', '너비 우선 탐색', '분리 집합'],
  description: '[Platinum IV] 문명 - 14868',
};
...
![그림](https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/14868/1.png)
...
while queue:
    ...
    for _ in range(len(queue)):
        ...
        for dr, dc in directions:
            ...
            elif target  문명이 올해 확장해서 겹쳐서 만난건지 딱 만난건지 확인 필요
