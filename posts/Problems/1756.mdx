export const metadata = {
  title: '[Gold V] 피자 굽기 - 1756',
  date: '2026-03-15 05:21:36',
  tags: ['구현'],
  description: '[Gold V] 피자 굽기 - 1756',
};
...
![그림](https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/upload/201006/pizz1.PNG)
