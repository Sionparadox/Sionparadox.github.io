export const metadata = {
  title: "[level 3] 매칭 점수 - 42893",
  date: "2026-09-04 13:30:25",
  tags: [],
  description: "[level 3] 매칭 점수 - 42893",
};
...
![그림](https://grepp-programmers.s3.amazonaws.com/files/production/48a36ec7fa/243a621b-f823-4ccd-99f1-2d8d3e14050d.jpg)
...
class Solution {
    ...
    public int solution(String word, String[] pages) {
        ...
        for (int i=0; i arr[answer].match_score) {
                answer = i;
            }
        }
    ...
    private String[] getLink(String page, String tag, String property){
        int tagStart = page.indexOf(" ret = new ArrayList<>();
