export const metadata = {
  title: '[Gold I] 도로검문 - 2307',
  date: '2026-04-08 09:35:23',
  tags: ['그래프 이론', '최단 경로', '데이크스트라', '역추적'],
  description: '[Gold I] 도로검문 - 2307',
};
...
![그림](https://upload.acmicpc.net/9f97f43f-357d-4818-8f7e-47b6a34cc52b/-/preview/)
...
### 입력 
 ...
 첫 줄에는 지점의 수를 나타내는 정수 N(6 ≤ N ≤ 1000)과 도로의 수 M(6 ≤ M ≤ 5000)이 주어진다. 그 다음 이어 나오는 M개의 각 줄에는 도로(a, b)와 그 통과시간 t가 a b t 로 표시된다. 단 이 경우 a 
