export const metadata = {
  title: '[Gold II] 과외맨 - 5213',
  date: '2025-08-12 09:03:40',
  tags: ['구현', '그래프 이론', '그래프 탐색', '너비 우선 탐색'],
  description: '[Gold II] 과외맨 - 5213',
};
...
![그림](https://upload.acmicpc.net/04f37a7b-2308-4f1c-837a-ad5197c14870/-/preview/)
...
def check(r, c, nr, nc, d):
    if nr = N or nc = 2*N: return False
