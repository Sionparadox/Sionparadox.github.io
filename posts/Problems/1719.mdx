export const metadata = {
  title: '[Gold III] 택배 - 1719',
  date: '2026-03-24 09:48:23',
  tags: ['그래프 이론', '최단 경로', '데이크스트라', '플로이드–워셜'],
  description: '[Gold III] 택배 - 1719',
};
...
![그림](https://www.acmicpc.net/JudgeOnline/upload/201005/taekbae.PNG)

예시된 그래프에서 굵게 표시된 1, 2, 3, 4, 5, 6은 집하장을 나타낸다. 정점간의 간선은 두 집하장간에 화물 이동이 가능함을 나타내며, 가중치는 이동에 걸리는 시간이다. 이로부터 얻어내야 하는 경로표는 다음과 같다.

![그림](https://www.acmicpc.net/JudgeOnline/upload/201005/tktk.PNG)
