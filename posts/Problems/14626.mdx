export const metadata = {
  title: '[Bronze I] ISBN - 14626',
  date: '2026-03-30 13:48:12',
  tags: ['수학', '구현', '브루트포스 알고리즘', '사칙연산'],
  description: '[Bronze I] ISBN - 14626',
};
...
![그림](https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/14626/1.png)
