export const metadata = {
  title: '[Gold III] 게리맨더링 - 17471',
  date: '2025-07-31 07:48:41',
  tags: ['수학', '그래프 이론', '브루트포스 알고리즘', '그래프 탐색', '너비 우선 탐색', '조합론', '깊이 우선 탐색'],
  description: '[Gold III] 게리맨더링 - 17471',
};
...
![그림](https://upload.acmicpc.net/08218f4c-2653-4861-a4c1-e7ce808f3a85/-/preview/)
...
![그림](https://upload.acmicpc.net/b82fcf21-6f4c-4797-bda6-215e14099d19/-/preview/)

			

![그림](https://upload.acmicpc.net/32947e26-4ec4-4b20-99f1-106d8386683d/-/preview/)

			

![그림](https://upload.acmicpc.net/f5dd6143-c013-46d3-ba4c-dadc48bdf5bc/-/preview/)

			

![그림](https://upload.acmicpc.net/548b1153-84de-4b85-9697-2561b019a02b/-/preview/)
