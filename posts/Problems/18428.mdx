export const metadata = {
  title: '[Gold V] 감시 피하기 - 18428',
  date: '2025-07-01 07:51:00',
  tags: ['백트래킹', '브루트포스 알고리즘'],
  description: '[Gold V] 감시 피하기 - 18428',
};
...
![그림](https://upload.acmicpc.net/c513ebb1-7a89-42c1-8d69-63b66b5d7dca/-/preview/)
...
![그림](https://upload.acmicpc.net/1c939daa-993c-43e7-8cdc-579d65bef994/-/preview/)

이 때 다음과 같이 3개의 장애물을 설치하면, 모든 학생들을 선생님의 감시로부터 피하도록 만들 수 있다.

![그림](https://upload.acmicpc.net/c752987a-3b50-4d94-8a8a-932d0e65dffe/-/preview/)
