export const metadata = {
  title: '[Gold II] 트리 - 4256',
  date: '2025-07-01 08:43:44',
  tags: ['트리', '분할 정복', '재귀'],
  description: '[Gold II] 트리 - 4256',
};
...
![그림](https://www.acmicpc.net/upload/images/tree(2).png)
...
![그림](https://www.acmicpc.net/upload/images/treeorder.png)
