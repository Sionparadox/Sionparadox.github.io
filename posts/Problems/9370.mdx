export const metadata = {
  title: '[Gold II] 미확인 도착지 - 9370',
  date: '2025-08-05 07:11:41',
  tags: ['그래프 이론', '최단 경로', '데이크스트라'],
  description: '[Gold II] 미확인 도착지 - 9370',
};
...
![그림](https://www.acmicpc.net/upload/images/destination.png)
...
### 입력 
 ...
 첫 번째 줄에는 테스트 케이스의 T(1 ≤ T ≤ 100)가 주어진다. 각 테스트 케이스마다
	...
	그 다음 m개의 각 줄마다 3개의 정수 a, b, d (1 ≤ a 
