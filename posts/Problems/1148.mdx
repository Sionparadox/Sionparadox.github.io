export const metadata = {
  title: '[Gold V] 단어 만들기 - 1148',
  date: '2026-02-19 07:47:50',
  tags: ['구현', '문자열'],
  description: '[Gold V] 단어 만들기 - 1148',
};
...
![그림](https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/1148/1.png)
