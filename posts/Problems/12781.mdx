export const metadata = {
  title: '[Gold III] PIZZA ALVOLOC - 12781',
  date: '2025-08-24 07:42:01',
  tags: ['기하학', '선분 교차 판정'],
  description: '[Gold III] PIZZA ALVOLOC - 12781',
};
...
![그림](https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/12781/1.png)
