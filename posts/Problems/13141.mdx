export const metadata = {
  title: '[Platinum V] Ignition - 13141',
  date: '2025-09-06 09:27:14',
  tags: ['그래프 이론', '브루트포스 알고리즘', '최단 경로', '플로이드–워셜'],
  description: '[Platinum V] Ignition - 13141',
};
...
![그림](https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/13141/I_ignite.png)
